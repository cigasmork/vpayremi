            ...
            <div className="p-4">
                ...
                <div className="space-y-4">
                    {mockTransactions.map(tx => {
                        const currencyData = CURRENCIES.find(c => c.code === tx.receivedCurrency);
                        const FlagComponent = currencyData?.flag;
                        return (
                                ...
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2 mt-1">
                                            {FlagComponent && <FlagComponent className="w-5 h-5 rounded-full" />}
